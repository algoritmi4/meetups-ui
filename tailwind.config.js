  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "slider-fade-out":
          "linear-gradient(to right, transparent, #FFFEFC 60%)",
        ...
        "user-profile": "url('images/user-profile.svg')",
        favorite: "url('images/favorite.svg')",
        plans: "url('images/plans.svg')",
        created: "url('images/created.svg')",
        visited: "url('images/visited.svg')",
        subscriptions: "url('images/subscriptions.svg')",
